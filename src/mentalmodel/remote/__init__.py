...
_LAZY_EXPORTS = {
    ...
    "TelemetryStore": ("mentalmodel.remote.telemetry_store", "TelemetryStore"),
    "TelemetryRunRecord": ("mentalmodel.remote.telemetry_store", "TelemetryRunRecord"),
    "InMemoryTelemetryStore": ("mentalmodel.remote.telemetry_store", "InMemoryTelemetryStore"),
    "ClickHouseTelemetryStore": (
        "mentalmodel.remote.telemetry_store",
        "ClickHouseTelemetryStore",
    ),
    "TelemetryIndexer": ("mentalmodel.remote.telemetry_indexer", "TelemetryIndexer"),
    "TelemetryConsumerConfig": (
        "mentalmodel.remote.telemetry_indexer",
        "TelemetryConsumerConfig",
    ),
